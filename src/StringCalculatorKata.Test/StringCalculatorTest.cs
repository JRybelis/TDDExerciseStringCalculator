...
namespace StringCalculatorKata.Test
{
    public class StringCalculatorTest
    {
        ...
        [TestCase("//@\n2@3@4@9", 18)]
        [TestCase("//#\n17#28#3", 48)]
        public void Add_SyntaxSupportingDifferentDelimiters_AcceptsTheDifferentDelimiter(string numbers, int expected)
        {
            Assert.AreEqual(expected, StringCalculator.Add(numbers));
        }

        [Test]
        public void Add_StringWithNegativeNumbersAsParam_ThrowsException()
        {
            const string numbers = "1,2,3,-5";
            Assert.Throws<ArgumentException>(() => StringCalculator.Add(numbers), "negatives not allowed: -5");
        }
        ...
        public void Add_StringWithNumbersLargerThan1000_ReturnsTheSumIgnoringNumbersLargerThan1000(string numbers,
            int expected)
        {
            Assert.AreEqual(expected, StringCalculator.Add(numbers));
        }
        ...
        [Test]
        public void Add_StringWirthMultipleDelimiters()
        {
